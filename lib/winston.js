...
//
const setLevels             = require('./winston/common/setLevels');
winston.hash           = require('./winston/common/hash');
winston.clone          = require('./winston/common/clone');
winston.longestElement = require('./winston/common/longestElement');
...
setLevels(winston, null, defaultLogger.levels);
...
winston.cli = function () {
  ...
  setLevels(winston, defaultLogger.levels, winston.config.cli.levels);
...
winston.setLevels = function (target) {
  setLevels(winston, defaultLogger.levels, target);
